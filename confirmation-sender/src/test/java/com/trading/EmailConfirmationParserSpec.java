...
public class EmailConfirmationParserSpec {
    ...
    public void retrieves_new_message_and_process_it_finally_saving_with_status_sent() throws Exception {
        ...
        AllocationReport allocationReportWithStatusSent = confirmation.get().getAllocationReport();

        assertThat(allocationReportWithStatusSent).isEqualToComparingFieldByField(
